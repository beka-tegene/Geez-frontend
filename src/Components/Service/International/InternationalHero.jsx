...
import { Card, CardActionArea, CardContent, ImageListItem, List, Stack, Typography } from "@mui/material";
    ...
    >
      ...
      >
        ...
        >
          ...
          <Typography>
            Ge'ez Bank S.C. provide International Banking services to its
            esteemed customers.
          </Typography>
          <Stack>
      ...
      <Stack direction={"row"} justifyContent={"space-between"} sx={{p:"2rem 0"}}>
