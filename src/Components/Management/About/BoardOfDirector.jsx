...
const BoardOfDirector = () => {
  ...
  const saveEditHandler = () => {
    setEditConfirmationOpen(true); // Open edit confirmation dialog
  };
  ...
  const submitHandler = async (e) => {
    ...
    try {
      ...
      await dispatch(setBoard(formData));
    } catch (error) {
  ...
  const handleDeleteConfirmation = () => {
    dispatch(setDeleteBoard({ data: { _id: deleteItemId } }));
  ...
  return (
    <Stack p={2} gap={2}>
      ...
      <Typography>Board Of Directer</Typography>
            ...
            <CardContent>
              ...
              {isEditing ? (
                ...
                <Typography variant="h7" color={"#EF9B01"}>
                  Ge'ez Bank S.C Board of Directors - {item.Position}
                </Typography>
              )}
            </CardContent>
          </Grid>
      ...
      >
        ...
        <DialogContent>
          Are you sure you want to delete this Board of Director?
        </DialogContent>
        <DialogActions>
          <Button
